...
make it easy to create multi threaded C++ applications. By Marcus Geelnard.
...
Run:
```bash
$ npm i tinythread.cxx
```

And then include `tinythread.h` as follows:
```c
#include "node_modules/tinythread.cxx/source/tinythread.h"
#include "node_modules/tinythread.cxx/source/fast_mutex.h"  // Optional
```

You may also want to include `tinythread.cxx` as follows:
```c
#ifndef __TINYTHREAD_CXX__
#define __TINYTHREAD_CXX__
#include "node_modules/tinythread.cxx/source/tinythread.cpp"
#endif
```
